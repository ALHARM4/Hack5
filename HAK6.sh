...
rasma(){
	...
	echo -e $red """
			...
			╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝
				...
				$yellow By :$red HOSAM$green HACKER  
	"""
...
PayLoaD(){
	...
	if [ $payload = 1 ] ; then 
		...
		if [ $root = 1 ] ; then 
			...
			mv $name.apk /Disktop/HAK5_PaYLOad
			clear
			...
			mv $name.exe /Disktop/HAK5_PaYLOad
			clear
			echo -e "$yellow The PaylOAD in $red HAK5_PaYLOad"
			sleep 5
			echo -e "$green[$red~$green]$cyan MSF Starting $red[ $yellow X = Ctrl + C $red ]"
			...
			mv $name.elf /Disktop/HAK5_PaYLOad
			clear
			echo -e "$yellow The PaylOAD in $red HAK5_PaYLOad"
			sleep 5
			echo -e "$green[$red~$green]$cyan MSF Starting $red[ $yellow X = Ctrl + C $red ]"
			...
			mv $name.api /Disktop/HAK5_PaYLOad
			clear
			echo -e "$yellow The PaylOAD in $red HAK5_PaYLOad"
			sleep 5
			echo -e "$green[$red~$green]$cyan MSF Starting $red[ $yellow X = Ctrl + C $red ]"
			...
			mv $name.py /Disktop/HAK5_PaYLOad
			clear
			echo -e "$yellow The PaylOAD in $red HAK5_PaYLOad"
			sleep 5
			echo -e "$green[$red~$green]$cyan MSF Starting $red[ $yellow X = Ctrl + C $red ]"
			...
			mv $name.macho /Disktop/HAK5_PaYLOad
			clear
			echo -e "$yellow The PaylOAD in $red HAK5_PaYLOad"
			sleep 5
			echo -e "$green[$red~$green]$cyan MSF Starting $red[ $yellow X = Ctrl + C $red ]"
