...
echo '''
      ...
      (Hosam sayd +  Asmae said)

     ( Login HACK5 By Hosam sayd)

'''
echo -e "$red---------<> $green((Login script)) $red<>----------"

       echo -e $blue"Enter username"
read user
      if [ $user -eq 123 ]
           then
         sleep 1.5
echo -e $green"welcome to Asmae "$user
sleep 0.6
else [ $user -ne 123 ]
  sleep 2
...
test2 (){
        ...
        echo -e $blue"Enter password"
read pwf
      if [ $pwf -eq 1234 ]
           then
         sleep 2
        echo -e $green"Done "$pwf
...
echo -e $Purple
figlet  -f big    "My  Love Asmae"
sleep 0.6
echo "  "

echo -e " $Purple=====================>> $Cyans(( I Love You Asmae )) $Purple<<====================="
...
rasma(){
	...
	echo -e $red """
			...
			╚═╝  ╚═╝╚═╝  ╚═╝╚═╝  ╚═╝╚══════╝
				...
				$yellow By :$red HOSAM$green Sayd  
	"""
...
PayLoaD(){
	...
	if [ $payload = 1 ] ; then 
		...
		if [ $root = 1 ] ; then 
			...
			mv $name.exe /Desktop/HAK5_PaYLOad
			clear
			echo -e "$yellow The PaylOAD in $red HAK5_PaYLOad"
			sleep 5
			echo -e "$green[$red~$green]$cyan MSF Starting $red[ $yellow X = Ctrl + C $red ]"
			...
			mv $name.elf /Desktop/HAK5_PaYLOad
			clear
			echo -e "$yellow The PaylOAD in $red HAK5_PaYLOad"
			sleep 5
			echo -e "$green[$red~$green]$cyan MSF Starting $red[ $yellow X = Ctrl + C $red ]"
			...
			mv $name.api /Desktop/HAK5_PaYLOad
			clear
			echo -e "$yellow The PaylOAD in $red HAK5_PaYLOad"
			sleep 5
			echo -e "$green[$red~$green]$cyan MSF Starting $red[ $yellow X = Ctrl + C $red ]"
			...
			mv $name.py /Desktop/HAK5_PaYLOad
			clear
			echo -e "$yellow The PaylOAD in $red HAK5_PaYLOad"
			sleep 5
			echo -e "$green[$red~$green]$cyan MSF Starting $red[ $yellow X = Ctrl + C $red ]"
			...
			mv $name.macho /Desktop/HAK5_PaYLOad
			clear
			echo -e "$yellow The PaylOAD in $red HAK5_PaYLOad"
			sleep 5
			echo -e "$green[$red~$green]$cyan MSF Starting $red[ $yellow X = Ctrl + C $red ]"
			...
			echo -e "$red++++++++++++++++++++++++++++++++++++++"
			sleep 0.1
			echo -e "$yellow By : $green HOSAM $cyan HACKER"
			sleep 0.1
			echo -e "$yellow facebook $red https://www.facebook.com/profile.php?id=100049331647083"
			sleep 0.1
			echo -e "$red++++++++++++++++++++++++++++++++++++++"
			sleep 3
			rasma
		...
		if [ $termux = 1 ] ; then 
			...
			echo -e "$yellow By : $green HOSAM $cyan HACKER"
			sleep 0.1
			echo -e "$yellow Telegram $red https://t.me/ALHARM4"
			sleep 0.1
			echo -e "$red++++++++++++++++++++++++++++++++++++++"
			sleep 3
			rasma
		...
		echo -e "$red++++++++++++++++++++++++++++++++++++++"
		sleep 0.1
		echo -e "$yellow By : $green HOSAM $cyan EGYPT"
		sleep 0.1
		echo -e "$yellow Telegram $red https://t.me/ALHARM4"
		sleep 0.1
		echo -e "$red++++++++++++++++++++++++++++++++++++++"
...
exit(){
	...
	echo -e "$red++++++++++++++++++++++++++++++++++++++" 
	sleep 0.2
	echo -e "$yellow By : $green HOSAM ALHARM $cyan HACKER"
	sleep 0.2
	echo -e "$yellow Telegram $red @ALHARM4"
	sleep 0.2
	echo -e "$red++++++++++++++++++++++++++++++++++++++" 
